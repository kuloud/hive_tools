...
import 'package:hive_tools/tools/category_list_item.dart';
...
class _AnimatedHomePageState extends State<_AnimatedHomePage>
  ...
  Timer? _launchTimer;
  final RestorableBool _isDeviceListExpanded = RestorableBool(false);
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    registerForRestoration(_isDeviceListExpanded, 'device_list');
  }
          ...
          children: [
            ...
            _AnimatedCategoryItem(
              ...
              child: CategoryListItem(
                  key: const PageStorageKey<ToolCategory>(
                    ToolCategory.device,
                  ),
                  restorationId: 'home_device_category_list',
                  category: ToolCategory.device,
                  imageString: 'assets/icons/material/material.png',
                  demos: Demos.deviceTools(),
                  initiallyExpanded: _isDeviceListExpanded.value,
                  onTap: (shouldOpenList) {
                    _isDeviceListExpanded.value = shouldOpenList;
                  }),
            ),
          ],
        ),
...
double _carouselHeight(double scaleFactor, BuildContext context) =>
    math.max(_carouselHeightMin * scaleFactor, _carouselHeightMin);
